function i_createPDF(){
    ...
    doc.text(`Parque`, 125.2, 60.4);
    doc.text(`Parque`, 125.2, 60.4);
    doc.text(`Parque`, 125.2, 60.4);
    doc.text(`Parque`, 125.2, 60.4);
    
    doc.text(`Servicio Funerario`, 56, 60.4);
    doc.text(`Servicio Funerario`, 56, 60.4);
    doc.text(`Servicio Funerario`, 56, 60.4);
    doc.text(`Servicio Funerario`, 56, 60.4);

    doc.text(`Precio de Servicio`, 54.87, 66.98);
    doc.text(`Precio de Servicio`, 54.87, 66.98);
    doc.text(`Precio de Servicio`, 54.87, 66.98);
    doc.text(`Precio de Servicio`, 54.87, 66.98);
    ...
    doc.text(`Precio de Parque`, 112, 66.98);
    doc.text(`Precio de Parque`, 112, 66.98);
    doc.text(`Precio de Parque`, 112, 66.98);
    doc.text(`Precio de Parque`, 112, 66.98);

    doc.text(`$ ${i_preciopdf.toString()}`, 112, 73);
