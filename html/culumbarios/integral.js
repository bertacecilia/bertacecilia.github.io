...
let i_opt_0 = ["San Salvador", "Santa Tecla"];
let i_opt_1 = ["San Salvador", "Santa Tecla"];
let i_opt_2 = ["San Salvador", "Santa Tecla", "Santa Ana", "Sonsonate"];
let i_opt_3 = ["San Salvador", "Santa Tecla", "Santa Ana", "Sonsonate"];
let i_opt_4 = ["San Salvador", "Santa Tecla", "Santa Ana", "Sonsonate"];

let i_opt_5 = ["San Salvador"];
let i_opt_6 = ["San Salvador"];
let i_opt_7 = ["San Salvador", "Soyapango"];
let i_opt_8 = ["San Salvador", "Soyapango"];
let i_opt_9 = ["San Salvador", "Soyapango"];

let i_lugar = "San Salvador"
let i_lugarValue = 0
let i_servicio = "Brillante"
...
let i_precio = 4500.00.toFixed(2)
let i_precioTotal = 4500.00.toFixed(2)
...
function i_precio_function() {
    if (i_servicioLugar == "Brillante0"){
        i_precio = 4500.00.toFixed(2)
    } else if (i_servicioLugar == "Brillante1") {
        i_precio = 4200.00.toFixed(2)
    } else if (i_servicioLugar == "Esmeralda0") {
        i_precio = 3750.00.toFixed(2)
    } else if (i_servicioLugar == "Esmeralda1") {
        i_precio = 3400.00.toFixed(2)
    } else if (i_servicioLugar == "Deluxe0") {
        i_precio = 2900.00.toFixed(2)
    } else if (i_servicioLugar == "Deluxe1") {
        i_precio = 2600.00.toFixed(2)
    } else if (i_servicioLugar == "Deluxe2") {
        i_precio = 2075.00.toFixed(2)
    } else if (i_servicioLugar == "Deluxe3") {
        i_precio = 2075.00.toFixed(2)
    } else if (i_servicioLugar == "Especial0") {
        i_precio = 2250.00.toFixed(2)
    } else if (i_servicioLugar == "Especial1") {
        i_precio = 1950.00.toFixed(2)
    } else if (i_servicioLugar == "Especial2") {
        i_precio = 1500.00.toFixed(2)
    } else if (i_servicioLugar == "Especial3") {
        i_precio = 1500.00.toFixed(2)
    } else if (i_servicioLugar == "Preferencial0") {
        i_precio = 1600.00.toFixed(2)
    } else if (i_servicioLugar == "Preferencial1") {
        i_precio = 1300.00.toFixed(2)
    } else if (i_servicioLugar == "Preferencial2") {
        i_precio = 970.00.toFixed(2)
    } else if (i_servicioLugar == "Preferencial3") {
        i_precio = 970.00.toFixed(2)
    } else if (i_servicioLugar == "Mónaco0") {
        i_precio = 4900.00.toFixed(2)
    } else if (i_servicioLugar == "Diamond0") {
        i_precio = 4200.00.toFixed(2)
    } else if (i_servicioLugar == "Elegance0") {
        i_precio = 3500.00.toFixed(2)
    } else if (i_servicioLugar == "Elegance1") {
        i_precio = 2300.00.toFixed(2)
    } else if (i_servicioLugar == "Esplendor0") {
        i_precio = 2750.00.toFixed(2)
    } else if (i_servicioLugar == "Esplendor1") {
        i_precio = 1700.00.toFixed(2)
    } else if (i_servicioLugar == "Estrella0") {
        i_precio = 2100.00.toFixed(2)
    } else if (i_servicioLugar == "Estrella1") {
        i_precio = 1100.00.toFixed(2)
    }
...
function integral() {
    if (document.services.places[document.services.places.selectedIndex].text == "Standar Sup Futuro" || document.services.places[document.services.places.selectedIndex].text == "Standar Sup Definida") {
        integralChecked.checked = false
    }
    windowLength = window.innerWidth
    if (windowLength < 910) {
        if (integralChecked.checked) {
...
function integralChecking() {
    ...
    if (integralChecked.checked || document.services.places[document.services.places.selectedIndex].text == "Standar Sup Futuro" || document.services.places[document.services.places.selectedIndex].text == "Standar Sup Definida") {
